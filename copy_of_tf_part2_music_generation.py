# -*- coding: utf-8 -*-
"""Copy of TF_Part2_Music_Generation.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1gz9io9nuqz8O55Z4TI2ofTsC_SYBJxo3
...
COMET_API_KEY = "CvpajtJgGTq1xs08E8VrCyvH3"
...
def vectorize_string(string):
    """Convert a string into a numeric vector using the global vocab dictionary."""
    return np.array([char2idx[char] for char in string if char in vocab])
...
def build_model(vocab_size, embedding_dim, rnn_units, batch_size):
  model = tf.keras.Sequential([
    ...
    # Layer 3: Dense layer to output vocabulary-sized logits
...
model = build_model(vocab_size=len(vocab), embedding_dim=params['embedding_dim'], rnn_units=params['rnn_units'], batch_size=1)
